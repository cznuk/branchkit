...
/**
 * ExplainerAnimation v15 - New Content Template
 *
 * Timeline Summary:
 * 0. Establish context (0.0s → 1.5s) - Real app running, BranchKit visible, v1 shown
 * 1. Fork (1.5s → 2.5s) - Click Fork, v2 appears, UI doesn't change yet
 * 2. Show editing once (2.5s → 5.0s) - Cut to editor, highlight small change, save
 * 3. Back to app → updated UI (5.0s → 6.0s) - Layout visibly changes
 * 4. Fork → cut → fork → cut montage (6.0s → 9.5s) - Compressed time
 * 5. Toggle between versions (9.5s → 12.5s) - Fast but readable switching
 * 6. Optional end card (12.5s → 14.0s) - BranchKit UI visible, versions list highlighted
 *
 * Key improvements:
 * - On-screen text overlays for each section
 * - Real app content with scroll/selection
 * - Explicit fork action (separate from editing)
 * - Single editing proof point
 * - Compressed montage after trust is established
 */
...
function OnScreenText({ text, visible }: { text: string; visible: boolean }) {
  ...
  return (
    ...
    >
      <div className="bg-black/80 dark:bg-white/90 backdrop-blur-sm text-white dark:text-gray-900 px-3 py-2 rounded text-sm font-medium">
        {text}
      </div>
    </motion.div>
  );
...
const ANIMATION_TIMELINE: TimelineAction[] = [
  // ─────────────────────────────────────────────────────────────────────────────
  // 0. Establish context (0.0s → 1.5s)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Establishing context" },
  ...
  // 1. Fork (1.5s → 2.5s) - Click Fork, v2 appears, UI doesn't change yet
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Opening BranchKit" },
  { type: "hideText" },
  { type: "showText", text: "Fork a version" },
  { type: "moveTo", target: "[data-branchkit-trigger]", duration: 800 },
  ...
  { type: "moveTo", target: "[data-new-version-button]", duration: 600 },
  { type: "wait", duration: 200 },
  { type: "click" },
  { type: "wait", duration: 200 },
  {
  ...
  // 2. Show editing once (2.5s → 5.0s) - Cut to editor, highlight small change, save
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Showing editor" },
  { type: "hideText" },
  ...
  { type: "wait", duration: 300 },
  // Small layout change - modify grid cols
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 3. Back to app → updated UI (5.0s → 6.0s)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Back to app" },
  { type: "hideText" },
  { type: "showText", text: "See it live" },
  { type: "hideEditor" },
  { type: "wait", duration: 200 },
  {
    type: "setState",
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 4. Fork → cut → fork → cut montage (6.0s → 9.5s)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Montage: Fork v3" },
  { type: "hideText" },
  { type: "showText", text: "Ideas accumulate" },
  { type: "moveTo", target: "[data-new-version-button]", duration: 400 },
  ...
  { type: "log", message: "Montage: Fork v4" },
  { type: "moveTo", target: "[data-new-version-button]", duration: 400 },
  { type: "wait", duration: 150 },
  { type: "click" },
  { type: "wait", duration: 200 },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 5. Toggle between versions (9.5s → 12.5s)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "Toggling versions" },
  { type: "hideText" },
  { type: "showText", text: "A visible trail of exploration" },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // 6. Optional end card (12.5s → 14.0s)
  // ─────────────────────────────────────────────────────────────────────────────
  { type: "log", message: "End card" },
  { type: "hideText" },
  { type: "showText", text: "Explore in code without losing ideas" },
  { type: "wait", duration: 1500 },
